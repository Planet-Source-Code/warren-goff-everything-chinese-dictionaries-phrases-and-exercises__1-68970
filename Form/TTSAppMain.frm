...
Begin VB.Form TTSAppMain 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox AudioOutputCB 
         BackColor       =   &H00D8E9EC&
         Height          =   315
         ItemData        =   "TTSAppMain.frx":0BD4
         Left            =   915
         List            =   "TTSAppMain.frx":0BD6
         Style           =   2  'Dropdown List
         TabIndex        =   19
         Top             =   1935
         Width           =   2385
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   585
         Left            =   2370
         Picture         =   "TTSAppMain.frx":0BD8
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Stop and Exit"
         Top             =   180
         Width           =   885
      End
      Begin Project1.cpvSlider cpvSlider1 
         ...
         _ExtentX        =   4207
         _ExtentY        =   423
         SliderIcon      =   "TTSAppMain.frx":14A2
         Orientation     =   0
         RailPicture     =   "TTSAppMain.frx":15BC
         Min             =   -10
      End
      Begin Project1.cpvSlider cpvSlider2 
         ...
         _ExtentX        =   4207
         _ExtentY        =   423
         SliderIcon      =   "TTSAppMain.frx":1A84
         Orientation     =   0
         RailPicture     =   "TTSAppMain.frx":1B9E
         Max             =   100
         Value           =   50
      End
