...
Begin VB.Form RecogVb 
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "Speak into the mic in Chinese and see how you   do "
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
...
Dim Inny, Outy, Moose, Goose, Textral As String
Dim i, j, k As Long
Screen.MousePointer = 11
DoEvents
Moose = ""
k = 0
Textral = Trim(Text1.Text)
'MsgBox Text
    Moose = ""
    For i = 1 To Len(Textral)
        Outy = Mid(Textral, i, 1)
        'MsgBox Outy
        If Asc(Outy) < 0 Then
...
'   Set up error handler
    ...
    Me.Top = FormX.Top  '(Screen.Height - Me.Height) / 2
    Me.Left = FormX.Left   '(Screen.Width - Me.Width) / 2
...
'   the user starts recognition.
    ...
    'RecoResult.PhraseInfo.LanguageId
...
Set RecogVb = Nothing
FormX.Command43.Caption = "Start Speech Recognition"
...
Private Sub Recognition_Click()
    ...
    Next
    If FormX.Option6.Value = True Then
        SREngines.ListIndex = 1
        SREngines.Text = "Microsoft Simplified Chinese Recognizer v5.1"
        SREngines_Click
    Else
        SREngines.ListIndex = 0
        SREngines.Text = "Microsoft English Recognizer v5.1"
        SREngines_Click
    End If
